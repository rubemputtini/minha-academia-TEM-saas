    ...
    public partial class v1_InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentSelections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EquipmentSelections_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coaches_Slug_Unique",
                table: "Coaches",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Equipments_BaseEquipmentId",
                table: "Equipments",
                column: "BaseEquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipments_CoachId",
                table: "Equipments",
                column: "CoachId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentSelections_UserId",
                table: "EquipmentSelections",
                column: "UserId");
